...
ALL_ITEMS: dict[str, Info] = {
    ...
    "52 Gold": Info(69), #GOLD_52
    "14 Gold": Info(70), #GOLD_14
    ...
    # USABLE ITEMS
    "Holy Water": Info(1, quantity=4), #ITEM_USE_ITEM_HOLY_WATER
    "Chimera Wing": Info(3, quantity=8), #ITEM_USE_ITEM_CHIMERA_WING
    "Medical Herb": Info(4, quantity=11), #ITEM_USE_ITEM_MEDICAL_HERB
    "Antidotal Herb": Info(6, quantity=5), #ITEM_USE_ITEM_ANTIDOTAL_HERB
    "Magic Water": Info(10, quantity=5), #ITEM_USE_ITEM_MAGIC_WATER
    "Whispering Nectar": Info(16, quantity=2), #ITEM_USE_ITEM_WHISPERING_NECTAR
    "Pouch of Musk": Info(23, quantity=3), #ITEM_USE_ITEM_POUCH_OF_MUSK
    ...
    "Dazzle-me-not": Info(68, quantity=2), #ITEM_USE_ITEM_DEDAZZLE_GRASS
    "Special Medicine": Info(75, quantity=2), #ITEM_USE_ITEM_SPECIAL_MEDICINE
    "Coagulant": Info(76, quantity=2), #ITEM_USE_ITEM_COAGULANT
    "Angel Bell": Info(77), #ITEM_USE_ITEM_SKYBELL
    "Sage Elixir": Info(88), #ITEM_USE_ITEM_SAGES_ELIXIR
    "Prayer Ring": Info(104, ItemClassification.useful), #ITEM_USE_ITEM_PRAYER_RING
    # USABLE ITEMS SEEDS
    "Seed of Strength": Info(9, ItemClassification.useful, quantity=5), #ITEM_USE_ITEM_SEED_OF_STRENGTH
    "Seed of Life": Info(15, ItemClassification.useful, quantity=2), #ITEM_USE_ITEM_SEED_OF_LIFE
    "Seed of Agility": Info(19, ItemClassification.useful, quantity=4), #ITEM_USE_ITEM_SEED_OF_AGILITY
    ...
    "Seed of Luck": Info(60, ItemClassification.useful, quantity=2), #ITEM_USE_ITEM_SEED_OF_LUCK
    # USABLE ITEMS BOOKS
    ...
    "Book: The Eureka Moment": Info(65), #ITEM_USE_ITEM_SMART_BOOK
    ...
    # MEDAL
    "Mini Medal": Info(11, ItemClassification.useful, quantity=18), #ITEM_SMALL_MEDAL # progression?
    # WEAPONS
    ...
    "Poison Needle": Info(78), #ITEM_EQUIP_WEAPON_POISON_NEEDLE
    ...
    "Turban": Info(63), #ITEM_EQUIP_HELMET_TURBAN
    ...
    "Boxer Shorts": Info(79), #ITEM_EQUIP_ARMOR_BOXER_SHORTS
    ...
    "Care Riviere": Info(93), #ITEM_EQUIP_ACCESSORY_SEALING_RESISTANCE_NECKLACE
